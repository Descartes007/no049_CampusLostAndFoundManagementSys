      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
             <form action="GoodsServlet?method=addGoodsAct&type=${type}" method="post" >
             ...
             <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                <div class="layui-input-block">
                  ...
                  <a href="GoodsServlet?method=goodsListAct1&whoLost=${username }" class="layui-btn layui-btn-primary" >返回</a>
                </div>
              </div>
              </form>
            </div>
