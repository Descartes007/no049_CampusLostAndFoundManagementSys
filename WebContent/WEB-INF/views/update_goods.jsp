      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
             <form action="GoodsServlet?method=updateGoodsAct" method="post" >
           ...
           <input type="hidden" name="id" value="${list.id}">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="gname" id="gname" value="${list.gname}"  lay-verify="required" lay-verType="tips" class="layui-input">
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="lostPlace" id="lostPlace"  value=" ${list.lostPlace}"  lay-verify="required" lay-verType="tips" class="layui-input">
                </div>
              </div>
            ...
            <div class="layui-input-inline">
              <textarea type="text" name="info2" id="info2" value="${list.info }" placeholder="请输入丢失物品特征" class="layui-textarea"></textarea>
            </div>
          </div>        
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="whoLost" id="whoLost"  value="${list.whoLost} "  lay-verify="required" lay-verType="tips" class="layui-input">
                </div>
              </div>
             ...
             <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                <div class="layui-input-block">
                  <button class="layui-btn" type="submit" id="addGoods">确认修改</button>
